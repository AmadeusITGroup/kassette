...
export const getPathParts = ({pathname}: URL): string[] => pathname === '/' ? [] : splitPath(pathname).slice(1);
...
export const build = ({protocol, hostname, port, pathname, search}: URLSpec): string => safeBuildString([
